...
public class TuplesTest {
    ...
    private Quartet<Integer, String, List<Time>, TimeDiff> quartet1;
    private Quartet<Integer, Triplet<Integer, Integer, String>, StopName, StopName> quartet2;
    ...
    public void setUp() {
        ...
        quartet1 = new Quartet<>(1, "quartet1", null, new TimeDiff(1));
        quartet2 = new Quartet<>(2, new Triplet<>(2, 2, "quartet2"), new StopName("quartet2"), new StopName("quartet22"));
    }
    ...
    public void getNthElement() {
        ...
        //quartets
        assertEquals(Integer.valueOf(1), quartet1.getFirst());
        assertEquals("quartet1", quartet1.getSecond());
        assertNull(quartet1.getThird());
        assertEquals(new TimeDiff(1), quartet1.getForth());
        assertEquals(Integer.valueOf(2), quartet2.getFirst());
        assertEquals(new Triplet<>(2, 2, "quartet2"), quartet2.getSecond());
        assertEquals(new StopName("quartet2"), quartet2.getThird());
        assertEquals(new StopName("quartet22"), quartet2.getForth());
    }
